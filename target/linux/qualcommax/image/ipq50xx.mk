...
define Device/fplus_wf-ap-624m-iic-v1
	$(call Device/FitImage)
	$(call Device/UbiFit)
	BLOCKSIZE := 128k
	PAGESIZE := 2048
	SOC := ipq5018
	DEVICE_VENDOR := Fplus
	DEVICE_TITLE := Fplus wf-ap-624m-iic-v1
	DEVICE_MODEL := WF-AP-624M-IIC-V3
	DEVICE_DTS := ipq5018-wf-ap-624m-iic-v1
	SUPPORTED_DEVICES := ikuai,sw8v1 fplus,wf-ap-624m-iic-v1
	DEVICE_DTS_CONFIG := config@mp03.1
